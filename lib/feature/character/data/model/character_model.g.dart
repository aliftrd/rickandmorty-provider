...
_CharacterModel _$CharacterModelFromJson(
  ...
  origin: OriginLocationModel.fromJson(json['origin'] as Map<String, dynamic>),
  location: OriginLocationModel.fromJson(
...
_OriginLocationModel _$OriginLocationModelFromJson(Map<String, dynamic> json) =>
